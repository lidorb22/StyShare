      ...
      <div className="sticky pointer-events-none bg-scroll top-0 xl:bg-transparent w-full xl:h-screen">
        ...
        {container !== "off" && (
          <div className="absolute top-0 left-0 h-screen w-full pt-[129px] pointer-events-none sm:pt-[169px] xl:pl-[351px] xl:pt-0">
            {container === "inbox" && (
              <div className="w-full h-full bg-first flex py-[40px] px-[20px] pointer-events-auto xl:px-[60px]">
            ...
            {container === "serch" && (
              <div className="w-full h-full flex flex-col gap-[30px] bg-gradient-to-b from-first to-first/90 overflow-y-auto backdrop-blur-[2px] pb-[40px] pointer-events-auto xl:px-[40px]">
